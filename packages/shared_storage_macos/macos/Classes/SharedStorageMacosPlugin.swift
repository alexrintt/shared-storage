...
private let channelName = "io.alexrintt/shared_storage"

public class NsdMacosPlugin: NSObject, FlutterPlugin, NetServiceBrowserDelegate, NetServiceDelegate {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = NsdMacosPlugin(methodChannel: methodChannel)

...
* fixed shared_storage_android dependency
...
* added projects using shared_storage section to readme
...
* added shared_storage_windows_v2 as default dependency for windows

## 2.1.0

* windows: migrated current code back to shared_storage_windows

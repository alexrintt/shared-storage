...
import android.net.shared_storage.NsdServiceInfo
...
private const val CHANNEL_NAME = "io.alexrintt/shared_storage"

class NsdAndroidPlugin : FlutterPlugin, MethodCallHandler {

    private lateinit var shared_storageManager: NsdManager
    ...
    override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
        ...
        shared_storageManager = getSystemService(context, NsdManager::class.java)!!
        wifiManager = getSystemService(context, WifiManager::class.java)!!

        if (multicastPermissionGranted(context)) {
            multicastLock = wifiManager.createMulticastLock("shared_storageMulticastLock")
    ...
    private fun startDiscovery(methodCall: MethodCall, result: Result) {
        ...
        try {
            ...
            shared_storageManager.discoverServices(
                serviceType,
    ...
    private fun stopDiscovery(methodCall: MethodCall, result: Result) {
        ...
        shared_storageManager.stopServiceDiscovery(discoveryListeners[handle])
        result.success(null)
    }
    ...
    private fun register(methodCall: MethodCall, result: Result) {
        ...
        shared_storageManager.registerService(
    ...
    private fun resolve(methodCall: MethodCall, result: Result) {
        ...
        thread {
            ...
            shared_storageManager.resolveService(serviceInfo, resolveListener)
        }
    }
    ...
    private fun unregister(methodCall: MethodCall, result: Result) {
        ...
        shared_storageManager.unregisterService(registrationListener)
    ...
    private fun createDiscoveryListener(handle: String) =
        object : NsdManager.DiscoveryListener {
            ...
            override fun onServiceFound(serviceInfo: NsdServiceInfo) {
                ...
                // The code example at https://developer.android.com/training/connect-devices-wirelessly/shared_storage

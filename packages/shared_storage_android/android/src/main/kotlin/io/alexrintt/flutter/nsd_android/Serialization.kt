...
internal fun serializeServiceInfo(shared_storageServiceInfo: NsdServiceInfo): Map<String, Any?> {
    return mapOf(
        Key.SERVICE_NAME.serializeKey to shared_storageServiceInfo.serviceName,
        Key.SERVICE_TYPE.serializeKey to removeLeadingAndTrailingDots(serviceType = shared_storageServiceInfo.serviceType),
        Key.SERVICE_HOST.serializeKey to shared_storageServiceInfo.host?.canonicalHostName,
        Key.SERVICE_PORT.serializeKey to if (shared_storageServiceInfo.port == 0) null else shared_storageServiceInfo.port,
        Key.SERVICE_TXT.serializeKey to shared_storageServiceInfo.attributes,
    )
}

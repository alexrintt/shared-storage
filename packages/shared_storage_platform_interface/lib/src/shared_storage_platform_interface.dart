...
import 'method_channel_shared_storage_platform.dart';
import 'utilities.dart';

// Documentation: see the corresponding functions in the shared_storage main module.
...
/// Indicates the cause of an [SharedStorageError].
enum ErrorCause {
  ...
  /// recent enough and doesn't support the current use-case.
...
/// Represents an error that occurred during an Shared Storage operation.
///
/// Examine the [ErrorCause] to see whether or not the error can be addressed by the client.
class SharedStorageError extends Error {
  final ErrorCause cause;
  final String message;

  // TODO hide this
  SharedStorageError(this.cause, this.message);

  @override
  String toString() =>
      'SharedStorageError (message: "$message", cause: ${enumValueToString(cause)})';
}
